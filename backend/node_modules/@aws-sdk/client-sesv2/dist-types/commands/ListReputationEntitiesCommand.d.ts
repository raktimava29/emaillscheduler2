...
declare const ListReputationEntitiesCommand_base: {
    new (input: ListReputationEntitiesCommandInput): import("@smithy/core/client").CommandImpl<ListReputationEntitiesCommandInput, ListReputationEntitiesCommandOutput, SESv2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListReputationEntitiesCommandInput]): import("@smithy/core/client").CommandImpl<ListReputationEntitiesCommandInput, ListReputationEntitiesCommandOutput, SESv2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
