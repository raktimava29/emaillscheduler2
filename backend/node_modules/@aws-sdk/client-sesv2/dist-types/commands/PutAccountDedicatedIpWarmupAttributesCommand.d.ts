...
declare const PutAccountDedicatedIpWarmupAttributesCommand_base: {
    new (input: PutAccountDedicatedIpWarmupAttributesCommandInput): import("@smithy/core/client").CommandImpl<PutAccountDedicatedIpWarmupAttributesCommandInput, PutAccountDedicatedIpWarmupAttributesCommandOutput, SESv2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [PutAccountDedicatedIpWarmupAttributesCommandInput]): import("@smithy/core/client").CommandImpl<PutAccountDedicatedIpWarmupAttributesCommandInput, PutAccountDedicatedIpWarmupAttributesCommandOutput, SESv2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
