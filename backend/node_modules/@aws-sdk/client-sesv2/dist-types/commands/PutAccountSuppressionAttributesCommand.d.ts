...
declare const PutAccountSuppressionAttributesCommand_base: {
    new (input: PutAccountSuppressionAttributesCommandInput): import("@smithy/core/client").CommandImpl<PutAccountSuppressionAttributesCommandInput, PutAccountSuppressionAttributesCommandOutput, SESv2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [PutAccountSuppressionAttributesCommandInput]): import("@smithy/core/client").CommandImpl<PutAccountSuppressionAttributesCommandInput, PutAccountSuppressionAttributesCommandOutput, SESv2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
