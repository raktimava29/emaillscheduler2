...
exports.parseJob = void 0;
var client_1 = require("../client");
var jobParser_prompt_1 = require("../prompts/jobParser-prompt");
var jobParser_schema_1 = require("../schemas/jobParser-schema");
var normalize_1 = require("../utils/normalize");
function parseJob(document) {
    var _a;
            ...
            switch (_b.label) {
                case 0: return [4 /*yield*/, client_1.groq.chat.completions.create({
                        ...
                        messages: [
                            {
                                role: "user",
                                content: jobParser_prompt_1.buildJobParserPrompt(document)
                            },
                        ]
                    })];
                case 1:
