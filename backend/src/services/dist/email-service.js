...
var email_prompt_1 = require("../prompts/email-prompt");
var email_schema_1 = require("../schemas/email-schema");
var errors_1 = require("../utils/errors");
function generateEmail(context) {
    var _a;
    return __awaiter(this, void 0, Promise, function () {
        var response, content, cleaned, parsed, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    response = _b.sent();
                    content = (_a = response.text) === null || _a === void 0 ? void 0 : _a.trim();
                    if (!content) {
                        throw new errors_1.AIError("EMPTY_AI_RESPONSE", "The AI returned an empty response", 500);
                    }
                    cleaned = content.replace(/^```json\s*/i, "")
                        .replace(/^```\s*/i, "")
                        .replace(/```$/i, "")
                        .trim();
