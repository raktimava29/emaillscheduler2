...
exports.jobParserController = void 0;
var documentParser_1 = require("../utils/documentParser");
var jobParser_service_1 = require("../services/jobParser-service");
var errors_1 = require("../utils/errors");
function jobParserController(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var document, result, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, documentParser_1.parseDocument(req.body.jobText, req.file)];
                case 1:
                    document = _a.sent();
                    return [4 /*yield*/, jobParser_service_1.parseJob(document.text)];
                case 2:
                    result = _a.sent();
                    res.json(result);
                    return [3 /*break*/, 4];
