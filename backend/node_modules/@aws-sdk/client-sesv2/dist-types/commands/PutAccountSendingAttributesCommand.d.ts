...
declare const PutAccountSendingAttributesCommand_base: {
    new (input: PutAccountSendingAttributesCommandInput): import("@smithy/core/client").CommandImpl<PutAccountSendingAttributesCommandInput, PutAccountSendingAttributesCommandOutput, SESv2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [PutAccountSendingAttributesCommandInput]): import("@smithy/core/client").CommandImpl<PutAccountSendingAttributesCommandInput, PutAccountSendingAttributesCommandOutput, SESv2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
