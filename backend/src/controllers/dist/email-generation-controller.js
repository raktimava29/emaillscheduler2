...
function emailGenerationController(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var context, email, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    context = candidate_selection_schema_1.CandidateContextSchema.parse(req.body);
                    return [4 /*yield*/, email_service_1.generateEmail(context)];
                case 1:
                    email = _a.sent();
